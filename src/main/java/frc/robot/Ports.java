...
public class Ports {
	...
	public static final CanDeviceId SHOOTER_TOP = new CanDeviceId(18, "Default Name");
	public static final CanDeviceId SHOOTER_BOTTOM = new CanDeviceId(19, "Default Name");


	
	public static final CanDeviceId PIVOT_MAIN = new CanDeviceId(17, "Default Name");
	public static final CanDeviceId PIVOT_FOLLOWER = new CanDeviceId(16, "Default Name");
