...
public class FieldConstants {
    ...
    public static final double FIELD_LENGTH_METERS = Units.feetToMeters(54.27083);
    public static final double FIELD_WIDTH_METERS = Units.feetToMeters(26.9375);
    ...
    public static Pose3d getGamePiece1() {
        if (isBlueAlliance()) {
            return new Pose3d(2.896, -1.210, 0, new Rotation3d());
        }
        return new Pose3d(13.645, -1.210, 0, new Rotation3d());
    }

    public static Pose3d getGamePiece2() {
        if (isBlueAlliance()) {
            return new Pose3d(2.896, -2.658, 0, new Rotation3d());
        }
        return new Pose3d(13.645, -2.658, 0, new Rotation3d());
    }

    public static Pose3d getGamePiece3() {
        if (isBlueAlliance()) {
            return new Pose3d(2.896, -4.106, 0, new Rotation3d());
        }
        return new Pose3d(13.645, -4.106, 0, new Rotation3d());
    }

    public static Pose3d GAME_PIECE_4 =
            new Pose3d(8.271, -0.753, 0, new Rotation3d());
    public static Pose3d GAME_PIECE_5 =
            new Pose3d(8.271, -2.429, 0, new Rotation3d());
    public static Pose3d GAME_PIECE_6 =
            new Pose3d(8.271, -4.106, 0, new Rotation3d());
    public static Pose3d GAME_PIECE_7 =
            new Pose3d(8.271, -5.782, 0, new Rotation3d());
    public static Pose3d GAME_PIECE_8 =
            new Pose3d(8.271, -7.458, 0, new Rotation3d());

    public static Pose3d BLUE_SPEAKER_BOTTOM_LEFT =
            new Pose3d(0.0381, 4.936617, 1.984502, new Rotation3d());
    ...
    public static Pose3d BLUE_SPEAKER_TOP_LEFT =
            new Pose3d(0.421894, 4.936617, 2.10566, new Rotation3d());
    public static Pose3d BLUE_SPEAKER_TOP_RIGHT =
            new Pose3d(0.421894, 6.159119, 2.10566, new Rotation3d());
    ...
    public static Pose3d RED_SPEAKER_TOP_LEFT =
            new Pose3d(16.119348, 6.159119, 2.10566, new Rotation3d());
    public static Pose3d RED_SPEAKER_TOP_RIGHT =
            new Pose3d(16.119348, 4.936617, 2.10566, new Rotation3d());
    ...
    public static Pose3d BLUE_AMP_BOTTOM_LEFT =
            new Pose3d(1.5367, 8.2042, 0.6604, new Rotation3d());
    public static Pose3d BLUE_AMP_BOTTOM_RIGHT =
            new Pose3d(2.1463, 8.2042, 0.6604, new Rotation3d());
    public static Pose3d BLUE_AMP_TOP_LEFT =
            new Pose3d(1.5367, 8.2042, 1.1176, new Rotation3d());
    public static Pose3d BLUE_AMP_TOP_RIGHT =
            new Pose3d(2.1463, 8.2042, 1.1176, new Rotation3d());

    public static Pose3d RED_AMP_BOTTOM_LEFT =
            new Pose3d(14.395958, 8.2042, 0.6604, new Rotation3d());
    public static Pose3d RED_AMP_BOTTOM_RIGHT =
            new Pose3d(15.005558, 8.2042, 0.6604, new Rotation3d());
    public static Pose3d RED_AMP_TOP_LEFT =
            new Pose3d(14.395958, 8.2042, 1.1176, new Rotation3d());
    public static Pose3d RED_AMP_TOP_RIGHT =
            new Pose3d(15.005558, 8.2042, 1.1176, new Rotation3d());
